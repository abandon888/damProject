    ...
    <div>
      <nav
        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse text-primary" id="navcol-1">
            <a
          ...
          <div className="row pt-5">
            <div className="col-md-8 col-xl-6 text-center text-md-start mx-auto">
              <div className="text-center">
                ...
                <h1 className="fw-bold">通过模型，实现水坝的可靠预测</h1>
              </div>
            </div>
      ...
      <footer className="bg-dark">
        <div className="container py-4 py-lg-5">
          ...
          <div className="text-muted d-flex justify-content-between align-items-center pt-3">
            <p className="mb-0">Copyright © 2023 3Dmodel,contract us</p>
